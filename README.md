...
| 🔭 **ต่อกับ Agent Orchestrator ได้** | [AO](https://github.com/Untrivial-ai/agent-orchestrator) คุมฝูง coding agent · `server/ao_bridge.py` อ่าน REST ของมันแล้ววาด worker เป็นตัวละครในห้องเดียวกัน — อ่านอย่างเดียว ไม่แตะ AO |
